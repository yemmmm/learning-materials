...
**OpenAI Whitepaper:** https://openai.com/index/codex-maxxing-long-running-work/
...
Appshots is the lighter-weight version of this. Sometimes I do not want Codex to operate the app yet. I just want to show it the thing I am looking at. On macOS, you can press both Command keys and send the frontmost window into a Codex thread with a screenshot and whatever text the app makes available.
