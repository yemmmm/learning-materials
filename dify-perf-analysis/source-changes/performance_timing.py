...
class PerformanceTimingLayer(GraphEngineLayer):
    ...
    def on_event(self, event: GraphEngineEvent) -> None:
        ...
        if isinstance(event, GraphRunStartedEvent):
            ...
            logger.info(
                ...
                wf_id, elapsed, self._node_count,
            )
            ...
            logger.info(
                ...
                wf_id, elapsed, self._node_count, event.exceptions_count,
            )
            ...
            logger.info(
                ...
                wf_id, event.node_id, event.node_type, event.node_title, ts,
            )
            ...
            logger.info(
                ...
                wf_id, event.node_id, event.node_type, elapsed, ts,
            )
            ...
            logger.info(
                ...
                wf_id, event.node_id, event.node_type, elapsed, event.error,
            )
    ...
    def on_graph_end(self, error: Exception | None) -> None:
        ...
        logger.info(
            ...
            wf_id, total_elapsed, self._node_count, error is not None,
        )
